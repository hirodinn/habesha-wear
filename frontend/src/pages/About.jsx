    ...
    <div className="min-h-screen py-12">
      <div className="container mx-auto px-4 mb-20 relative">
        <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10">
          <div className="absolute top-0 left-1/4 w-96 h-96 bg-[var(--color-burgundy)]/10 rounded-full blur-[120px]" />
          <div className="absolute bottom-0 right-1/4 w-96 h-96 bg-[var(--color-burgundy)]/10 rounded-full blur-[120px]" />
        </div>
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[var(--color-burgundy)]/10 border border-[var(--color-burgundy)]/20 mb-6">
            <Sparkles className="w-4 h-4 text-[var(--color-burgundy)]" />
            <span className="text-sm font-semibold text-[var(--color-burgundy)]">
              About Us
            </span>
          </div>
          <h1 className="font-display text-5xl md:text-6xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-[var(--color-burgundy)] via-[var(--color-burgundy)] to-[var(--color-burgundy)]">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="card-standard p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group border-[var(--color-burgundy)]/10"
              >
                <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-[var(--color-burgundy)] to-[var(--color-burgundy)] text-white mb-4 shadow-lg group-hover:scale-105 transition-transform">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {features.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="card-standard p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 group border-[var(--color-burgundy)]/10"
              >
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br from-[var(--color-burgundy)] to-[var(--color-burgundy)] text-white mb-5 shadow-lg group-hover:scale-105 transition-transform">
      ...
      <div className="container mx-auto px-4 mb-20">
        <div className="card-standard p-10 md:p-16 max-w-4xl mx-auto text-center relative overflow-hidden border-[var(--color-burgundy)]/10">
          <div className="absolute top-0 right-0 w-40 h-40 bg-[var(--color-burgundy)]/10 rounded-full blur-3xl -z-10" />
          <div className="absolute bottom-0 left-0 w-40 h-40 bg-[var(--color-burgundy)]/10 rounded-full blur-3xl -z-10" />
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-gradient-to-br from-[var(--color-burgundy)] to-[var(--color-burgundy)] text-white mb-8 shadow-xl">
      ...
      <div className="container mx-auto px-4">
        <div className="card-standard p-10 md:p-16 max-w-4xl mx-auto text-center border-0 bg-gradient-to-br from-[var(--color-burgundy)] to-[var(--color-burgundy)]/90 text-white shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              to="/"
              className="inline-flex items-center justify-center px-8 py-4 rounded-xl font-semibold bg-white text-[var(--color-burgundy)] hover:bg-white/90 transition-all shadow-lg"
            >
              Start Shopping
            </Link>
            <Link
